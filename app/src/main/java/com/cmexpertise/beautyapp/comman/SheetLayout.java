package com.cmexpertise.beautyapp.comman;
...
import com.cmexpertise.beautyapp.revalAnimation.animation.SupportAnimator;
...
public class SheetLayout extends FrameLayout {
    ...
    private void expandPreLollipop(int x, int y, float startRadius, float endRadius) {
        ...
        SupportAnimator toolbarExpandAnim = com.cmexpertise.beautyapp.revalAnimation.animation.ViewAnimationUtils
    ...
    private void contractPreLollipop(int x, int y, float startRadius, float endRadius) {
        ...
        final SupportAnimator toolbarContractAnim = com.cmexpertise.beautyapp.revalAnimation.animation.ViewAnimationUtils
